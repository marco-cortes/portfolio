            ...
            <div className="qualification__container container">
                ...
                <div className="qualification__sections">
                    ...
                    <div className="qualification__content qualification__active" data-content id="education">
                        ...
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">Azure AZ-900</h3>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">Oracle Database Foundations</h3>
                    ...
                    <div className="qualification__content" data-content id="work">
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">Universidad Spring</h3>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">HTML, CSS y JS</h3>
                                <span className="qualification__subtitle">México - Udemy</span>
                                <div className="qualification__calendar">
                                    <i className="uil uil-calendar-alt"></i> Diciembre 2021
                                </div>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">React + Firebase</h3>
                                <span className="qualification__subtitle">México - Udemy</span>
                                <div className="qualification__calendar">
                        ...
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">MVC con Laravel</h3>
                                <span className="qualification__subtitle">México - UNAM</span>
                                <div className="qualification__calendar">
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">Desarrollo web con PHP</h3>
                                <span className="qualification__subtitle">México - UNAM</span>
                                <div className="qualification__calendar">
                                    <i className="uil uil-calendar-alt"></i> Febrero 2021
                                </div>
